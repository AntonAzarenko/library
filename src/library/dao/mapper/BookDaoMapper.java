...
public class BookDaoMapper extends SqlSessionDaoSupport implements BookDao {
	...
	return getSqlSession().selectOne("library.dao.BookDao.read");
    }
    ...
    @Override
    public List<Book> findBooksByPublisherId(final Long id) {
	return getSqlSession().selectList("library.dao.BookDao.findBooksByPublisherId", id);
    }
}
